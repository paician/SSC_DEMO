...
function localeUrl(href, requestedLocale) {
...
function createTranslator(locale = resolveLocale()) {
...
function applyLocale(){
  document.documentElement.lang = locale==='zh-CN'?'zh-Hans-CN':'en-US'; document.title=t('app.title');
